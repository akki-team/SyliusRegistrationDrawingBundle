...
final class Version20230109154453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registration_drawing_field_association (id INT AUTO_INCREMENT NOT NULL, drawing_id INT NOT NULL, ordre INT DEFAULT NULL, position INT DEFAULT NULL, length INT DEFAULT NULL, format VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
